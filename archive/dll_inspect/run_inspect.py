...
dlls = [
    r"D:\BIMBASE\BIMBase建模软件 2025\PLATFORM\BIMBaseNet.dll",
    r"D:\BIMBASE\BIMBase建模软件 2025\PLATFORM\BIMBaseNet.BIMCore.dll",
    r"D:\BIMBASE\BIMBase建模软件 2025\PLATFORM\BIMBaseNet.Geometries.dll",
    r"D:\BIMBASE\BIMBase建模软件 2025\PLATFORM\BPPythonBfaAdapter.dll",
    r"D:\BIMBASE\BIMBase建模软件 2025\PLATFORM\BPGeomBaseTool.dll",
    r"D:\BIMBASE\BIMBase建模软件 2025\BIMBase\BimBaseModel.dll",
    r"D:\BIMBASE\BIMBase建模软件 2025\PLATFORM\BPPrimaryElement.dll",
    r"D:\BIMBASE\BIMBase建模软件 2025\PLATFORM\BIMBaseBackEndCSharp.dll",
]

with open("dlls.txt", "w", encoding="utf-8") as f:
    for d in dlls:
        f.write(d + "\n")
...
with open("inspect.ps1", "w", encoding="utf-8-sig") as f:
    f.write(ps_script)

print("Running PowerShell inspection...")
result = subprocess.run(
    ["powershell.exe", "-ExecutionPolicy", "Bypass", "-File", "inspect.ps1"],
    capture_output=True,
    text=True,
    encoding="utf-8",
    errors="replace"
