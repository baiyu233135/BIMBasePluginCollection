# -*- coding: utf-8 -*-
"""
生成《智检桥安-命题解决方案（对标版）v3.docx》—— 对标沈阳建筑大学模板格式。

项目：智检桥安——基于人工智能与计算机视觉的桥梁表观损伤智能检测系统
命题：基于人工智能与计算机视觉的桥梁表观损伤智能检测系统开发（命题企业：广联达）
输出：docs/国创赛ppt/智检桥安-命题解决方案（对标版）v3.docx
...
OUT_PATH = os.path.join(PPT_DIR, "智检桥安-命题解决方案（对标版）v3.docx")
...
def main():
    ...
    doc = Document()
    setup_page(doc)
    doc.core_properties.title = "智检桥安-命题解决方案（对标版）v3"
