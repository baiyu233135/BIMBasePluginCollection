...
使用方法：
    ...
    2. 在 BIMBase 命令栏输入：
       exec(open(r'C:\ProgramData\PKPM\BIMBase\Plugins\Pro\V1.6\pythonplugin\CADBoard\auto_patch_board.py').read())
...
def find_board_py():
    ...
    candidates = [
        ...
        r'D:\ProgramData\PKPM\BIMBase\Plugins\Pro\V1.6\pythonplugin\CADBoard\board.py',
    ]
    for p in candidates:
        if os.path.exists(p):
            return p
