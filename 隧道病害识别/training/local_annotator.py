...
def main_cli():
    """命令行模式：批量生成伪标签"""
    parser = argparse.ArgumentParser(description="隧道病害照片标注工具")
...
def main_gui():
    ...
    class ImageCanvas(QLabel):
        ...
        def _update_display(self):
            ...
            pen_colors = {
                ...
                1: QColor(0, 128, 255),    # 渗水 蓝
                2: QColor(255, 128, 0),    # 剥落 橙
                3: QColor(0, 200, 0),      # 其他 绿
            }
    ...
    class AnnotatorWindow(QMainWindow):
        def __init__(self):
            super().__init__()
            self.setWindowTitle("隧道病害照片标注工具")
