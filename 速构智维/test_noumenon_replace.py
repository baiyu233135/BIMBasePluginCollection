...
在BIMBase底部命令行中输入：
    exec(open(r'C:\ProgramData\PKPM\BIMBase\Plugins\Pro\V1.6\pythonplugin\速构智维\test_noumenon_replace.py').read())
"""
from pyp3d import get_all_instancekey, get_noumenon_from_instancekey
import traceback

out_path = r"C:\ProgramData\PKPM\BIMBase\Plugins\Pro\V1.6\pythonplugin\速构智维\test_noumenon_output.txt"
