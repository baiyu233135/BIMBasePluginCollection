...
class 斜拉索(Component):
    ...
    def __init__(self):
        ...
        self['斜拉索半径'] = Attr(82, obvious=True)
        self['竖向距离'] = Attr(170000, obvious=True)
        self['横向距离'] = Attr(2800, obvious=True)
        self['竖向间距'] = Attr(5000, obvious=True)
        self['横向间距'] = Attr(28000, obvious=True)
        self['上间距'] = Attr(2000, obvious=True)
        self['下间距'] = Attr(35000, obvious=True)
