...
class 椭圆墩柱(Component):
    def __init__(self):
        Component.__init__(self)
        self['底长(m)'] = Attr(152.8,obvious = True)
        self['底宽(m)'] = Attr(57.8,obvious = True)
        self['底高'] = Attr(42,obvious = True)
        self['上长'] = Attr(122,obvious = True)
        self['上宽'] = Attr(42,obvious = True)
        self['上高'] = Attr(30,obvious = True)
        self['椭圆墩柱'] = Attr(None, show=True)
