...
class 电线杆(Component):
    def __init__(self):
        ...
        self['弹簧长'] = Attr(300,obvious = True)
        self['弹簧短半径'] = Attr(50,obvious = True)
        self['弹簧长半径'] = Attr(100,obvious = True)

        self['短管半径'] = Attr(5,obvious = False)
        self['短管长'] = Attr(320,obvious = False)

        self['电线长'] = Attr(200000,obvious = True)
        self['电线半径'] = Attr(10,obvious = True)

        self['电线杆'] = Attr(None,show = True)
    ...
    def replace(self):
        ...
        string_3 = trans(0, left_triangle_long / 4 - R1 - 50,
                   ...
                   rotate(Vec3(1, 0, 0),
                          -pi / 2 + math.atan(left_triangle_high / left_triangle_long)) * string
        ...
        triangle_down = trans(0, -R1 - 50, down_column_high - left_triangle_high - R4) * \
                        rotate(Vec3(1, 0, 0),
                               -pi / 2 + math.atan(left_triangle_high / left_triangle_long)) * \
        ...
        self['电线杆'] = Combine(line_all, poles)
