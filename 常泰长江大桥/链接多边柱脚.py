...
class 链接多边柱脚(Component):
    ...
    def replace(self):
        ...
        self['链接多边柱脚'] = Combine(ZH, JI)

if __name__ == "__main__":
    FinalGeometry = 链接多边柱脚()
