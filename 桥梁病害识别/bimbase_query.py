...
# bimbase_sync 位于 速构智维 目录，需要加入路径
_cadboard_dir = os.path.join(_current_dir, '..', '速构智维')
...
COMPONENT_SIGNATURES = {
    ...
    # 组件测试的引桥桥墩（盖梁总长/墩柱直径/墩高 三键特征，区别于异形盖梁）
    '引桥桥墩': {
        'required_keys': {'盖梁总长', '墩柱直径', '墩高'},
        'optional_keys': {'墩柱间距', '系梁根数', '盖梁总高', '盖梁宽'},
    },
    '桩基承台': {
